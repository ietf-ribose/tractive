...
RSpec.describe Migrator::Converter::RtfToMarkdown do
  let(:rtf_to_markdown) { Migrator::Converter::RtfToMarkdown.new(*options_for_markdown_converter.values) }

  it "should convert ticket base url" do
    str = "https://foo.bar/trac/foobar/ticket/123"

    rtf_to_markdown.send(:convert_ticket, str, options_for_markdown_converter[:base_url])
  ...
  it "should convet headings properly" do
    ...
    rtf_to_markdown.send(:convert_headings, str)
  ...
  it "should convert line endings" do
    ...
    rtf_to_markdown.send(:convert_newlines, str)
  ...
  it "should convert code snippets" do
    ...
    rtf_to_markdown.send(:convert_code_snippets, str)
  ...
  it "should convert font styles" do
    ...
    rtf_to_markdown.send(:convert_font_styles, bold)
    rtf_to_markdown.send(:convert_font_styles, italic)
  ...
  it "should convert links" do
    ...
    rtf_to_markdown.send(:convert_links, str)
  ...
  it "should convert image" do
    ...
    rtf_to_markdown.send(:convert_image, img1, base_url, attach_url, wiki_attachments_url)
    rtf_to_markdown.send(:convert_image, img2, base_url, attach_url, wiki_attachments_url)
    rtf_to_markdown.send(:convert_image, img3, base_url, attach_url, wiki_attachments_url)
    rtf_to_markdown.send(:convert_image, img4, base_url, attach_url, wiki_attachments_url)
