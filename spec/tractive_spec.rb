...
RSpec.describe Tractive do
  ...
  def ticket_compose_hash98(ticket)
    ...
    {
      "comments" =>[
        { "body" => "_@fenner@research.att.com_ _commented_\n\n\n___\nP.S. using NULL as the \"no RFC\" flag value may not be compatible with existing perl scripts that modify the internet_drafts table.", "created_at" => format_time(changes[0][:time]) },
